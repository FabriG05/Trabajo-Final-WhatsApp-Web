...
const SidebarHeader = () => {
    return (
        <div className="sidebar-header">
            <header className="sidebar-header__top">
                <div className="sidebar-header__top-title">
                    <h1>WhatsApp</h1>
                </div>
                <div className="sidebar-header__top-icons">
            ...
            <div className="sidebar-header__search-bar">
